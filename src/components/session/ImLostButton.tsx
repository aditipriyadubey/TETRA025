...
import { HelpCircle, Sparkles, Loader2, X, Compass, Lightbulb, BookOpen } from "lucide-react";
...
export function ImLostButton({ onImLost, currentDifficulty }: ImLostButtonProps) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/70 backdrop-blur-md px-4">
          <div className="animate-rise glass max-w-lg w-full rounded-3xl p-6 sm:p-8 space-y-5 shadow-2xl border border-destructive/30">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex size-8 items-center justify-center rounded-full text-muted-foreground hover:bg-elevated hover:text-foreground"
              >
                <X className="size-4" />
              </button>
            </div>
